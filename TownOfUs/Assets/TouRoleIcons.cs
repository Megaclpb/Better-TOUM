...
public static class TouRoleIcons
{
    ...
    public static LoadableAsset<Sprite> Shapeshifter { get; } =
        new LoadableBundleAsset<Sprite>("Shapeshifter", TouAssets.MainBundle);
    ...
    public static LoadableAsset<Sprite> Viper { get; } =
        new LoadableBundleAsset<Sprite>("Viper", TouAssets.MainBundle);
    ...
    public static LoadableAsset<Sprite> Crewmate { get; } =
        new LoadableBundleAsset<Sprite>("Crewmate", TouAssets.MainBundle);

    public static LoadableAsset<Sprite> Neutral { get; } =
        new LoadableBundleAsset<Sprite>("Neutral", TouAssets.MainBundle);

    public static LoadableAsset<Sprite> Impostor { get; } =
        new LoadableBundleAsset<Sprite>("Impostor", TouAssets.MainBundle);
